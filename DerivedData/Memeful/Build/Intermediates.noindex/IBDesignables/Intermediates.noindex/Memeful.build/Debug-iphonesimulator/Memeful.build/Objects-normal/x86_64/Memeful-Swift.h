...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Memeful",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC7Memeful10ApiManager")
...
SWIFT_CLASS("_TtC7Memeful11AppDelegate")
...
SWIFT_CLASS("_TtC7Memeful11CustomLabel")
...
SWIFT_CLASS("_TtC7Memeful7Gallery")
@interface Gallery : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7Memeful21GradientColorUIButton")
@interface GradientColorUIButton : UIButton
@property (nonatomic, strong) UIColor * _Nonnull topColor;
@property (nonatomic, strong) UIColor * _Nonnull bottomColor;
@property (nonatomic, strong) UIColor * _Nonnull shadowColors;
...
@property (nonatomic) CGFloat endPointX;
@property (nonatomic) CGFloat endPointY;
@property (nonatomic) CGFloat cornerRadius;
...
SWIFT_CLASS("_TtC7Memeful19GradientColorUIView")
@interface GradientColorUIView : UIView
@property (nonatomic, strong) UIColor * _Nonnull topColor;
@property (nonatomic, strong) UIColor * _Nonnull bottomColor;
@property (nonatomic, strong) UIColor * _Nonnull shadowColors;
@property (nonatomic) CGFloat shadowX;
...
SWIFT_CLASS("_TtC7Memeful6Images")
...
SWIFT_CLASS("_TtC7Memeful27MostViralCollectionViewCell")
@interface MostViralCollectionViewCell : UICollectionViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified titleLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imageView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified descriptionLabel;
@property (nonatomic, weak) IBOutlet UIStackView * _Null_unspecified titleStackView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified pointsLabel;
@property (nonatomic, weak) IBOutlet UIStackView * _Null_unspecified imageStackView;
...
SWIFT_CLASS("_TtC7Memeful29MostViralDetailViewController")
@interface MostViralDetailViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIActivityIndicatorView * _Null_unspecified indicatorView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified nameStartingLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified displayNameLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified descriptionLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified viewsCountLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imageView;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC7Memeful23MostViralViewController")
@interface MostViralViewController : UIViewController
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified collectionView;
@property (nonatomic, weak) IBOutlet UIActivityIndicatorView * _Null_unspecified acitvityIndicator;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface MostViralViewController (SWIFT_EXTENSION(Memeful)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
SWIFT_CLASS("_TtC7Memeful18PageViewController")
...
@interface PageViewController (SWIFT_EXTENSION(Memeful)) <UIPageViewControllerDataSource, UIPageViewControllerDelegate>
...
SWIFT_CLASS("_TtC7Memeful13SceneDelegate")
